  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "p",
        null,
        "Check color consistency for the selected frame."
      ),
      React.createElement(
        "button",
        { className: "button", id: "check-colors", onClick: onColorCheck },
        "Check Colors"
      )
    ),
    React.createElement(
      ...
      React.createElement(
        "p",
        null,
        "Convert selected frame to light / dark theme."
      ),
      React.createElement(
        "div",
        ...
        React.createElement(
          ...
          React.createElement(
            "button",
            { className: "button", id: "dark-theme", onClick: onDarkTheme },
            "Dark"
          ),
          React.createElement(
            "button",
            { className: "button", id: "light-theme", onClick: onLightTheme },
            "Light"
          )
        )
      )
    ...
    selected && layoutMode !== "NONE"
      ? React.createElement(AutoLayoutSpacingSection, {
...
const AutoLayoutSpacingSection = (props) =>
  React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(SliderHorizontal, {
    ...
    React.createElement(
      ...
      React.createElement(SliderVertical, {
        layoutMode: props.layoutMode,
    ...
    React.createElement(
      ...
      React.createElement(SliderItemSpacing, {
        layoutMode: props.layoutMode,
    ...
    React.createElement(
      "p",
      null,
      "Auto Layout padding & spacing from frame names."
    ),
    React.createElement(
      "button",
      {
