...
const SliderItemSpacing = (props) => (React.createElement("div", null,
    ...
    React.createElement("input", { disabled: props.layoutMode == "NONE" ? true : false, className: "padding-input-range", name: "itemSpacing", type: "range", step: "1", min: "0", max: "7", value: props.itemSpacing, onChange: props.onItemSpacingSlider })));
